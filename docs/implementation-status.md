...
v8.46 makes task-scoped artifact manifest proofs inspectable through HEAD headers without returning JSON bytes. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
