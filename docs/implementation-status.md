...
Node
  ...
  -> asp-verify.mjs swarm-close <frame.json> <trusted-zones.json> CLI for one FED_SWARM_CLOSE signature, digest, and structural close-proof/close-signature/step-receipt identity/task-id/uniqueness/NUL check
