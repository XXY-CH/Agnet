...
v10.8 is closed. The next natural boundary should keep making the accountability layer easier to verify externally: provide a reproducible public-node/Docker demo, or add npm-facing packaging only if the existing Node exports are not enough.
