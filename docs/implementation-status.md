...
状态：v12.22 active
当前代码基线：`v12.22-package-proof-verifier`
...
Node
  ...
  -> asp-verify.mjs package-proof <manifest.json> verifies package proof_digest, tarball sha256, and tarball size
