...
状态：v9.1 complete
当前代码基线：`v9.1-artifact-store-gc-plan`
...
v9.1 adds a GC plan over the verified filesystem artifact mirror index. The next natural boundary is artifact GC apply/delete over the plan, container namespace sandboxing, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
