...
状态：v13 active at v13.8
当前代码基线：`v13.8-pinned-external-observer-identity`
...
The active protocol tag is `v13.8-protocol`: pinned external observer identity is the latest complete slice, while the v13.1 hosted external-host observer run and hardware remote attestation remain pending exit criteria.
