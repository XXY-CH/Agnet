...
v9.11 persists sandbox runtime probe evidence when unsupported container namespace claims are rejected before tool start. The next natural boundary is real container namespace sandboxing or another small Ultimate-aligned runtime/governance slice.
