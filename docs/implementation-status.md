...
v8.34 displays persisted transcript artifact links in the Human Gateway receipt table. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
