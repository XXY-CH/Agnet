...
v8.53 adds a content-addressed object index for filesystem artifact mirrors. The next natural boundary is artifact GC, container namespace sandboxing, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
