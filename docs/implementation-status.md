...
状态：v12.24 active
当前代码基线：`v12.24-package-proof-tarball-path`
...
Node
  ...
  -> asp-verify.mjs package-proof <manifest.json> verifies package proof_digest, tarball sha256, and tarball size, rejects non-object package proof manifests, and rejects unsafe package proof tarball paths
