...
状态：v12.18 active
当前代码基线：`v12.18-package-artifact-proof`
...
Node
  ...
  -> scripts/package-proof.mjs creates a local npm tarball artifact with npm shasum, integrity, size, and file-list metadata
