...
v8.45 makes artifact manifest retrieval task-scoped when a task id is supplied. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
