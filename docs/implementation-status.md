...
状态：v13 active at v13.7
当前代码基线：`v13.7-sandbox-attestation-verifier`
...
The active protocol tag is `v13.7-protocol`: signed sandbox attestation verification is the latest complete slice, while the v13.1 hosted external-host observer run and hardware remote attestation remain pending exit criteria.
