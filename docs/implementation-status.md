...
状态：v9.31 complete
当前代码基线：`v9.31-swarm-artifactless-step-uniqueness`
...
v9 is closed at v9.31. The next natural boundary should start v10+ and either deepen Swarm orchestration without building a scheduler too early, align Node artifact manifests with Go, or start a real container namespace sandbox proof.
