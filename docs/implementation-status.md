...
状态：v12.20 active
当前代码基线：`v12.20-package-proof-manifest`
...
Node
  ...
  -> scripts/package-proof.mjs creates a local npm tarball artifact and package-proof.json manifest with npm shasum, integrity, SHA-256, size, and file-list metadata
