...
v9.15 adds optional `AGNET_CONTAINER_RUNTIME` candidate evidence to container namespace probes while still failing closed. The next natural boundary is real container namespace sandbox execution proof or another small Ultimate-aligned runtime/governance slice.
