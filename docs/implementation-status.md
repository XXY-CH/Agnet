...
v8.36 exposes task-scoped audit receipt proof links in the Human Gateway. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
