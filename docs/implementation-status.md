...
状态：v12.27 active
当前代码基线：`v12.27-package-proof-verified-metadata-output`
...
Node
  ...
  -> asp-verify.mjs package-proof <manifest.json> verifies package proof_digest, manifest-relative tarball sha256, npm shasum, npm integrity, and manifest-relative tarball size, returns verified package metadata, rejects non-object package proof manifests, and rejects unsafe package proof tarball paths
