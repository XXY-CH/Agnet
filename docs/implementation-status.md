...
v9.14 adds `--sandbox-require <claim>` as a fail-closed sandbox preflight. The next natural boundary is real container namespace sandboxing or another small Ultimate-aligned runtime/governance slice.
