...
状态：v8.44 complete
当前代码基线：`v8.44-artifact-verify-proof-digests`
...
v8.44 makes receipt-scoped artifact verify responses expose receipt digest and audit hash proof fields. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
