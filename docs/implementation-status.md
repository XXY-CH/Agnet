...
状态：v12.23 active
当前代码基线：`v12.23-package-proof-manifest-object`
...
Node
  ...
  -> asp-verify.mjs package-proof <manifest.json> verifies package proof_digest, tarball sha256, and tarball size, and rejects non-object package proof manifests
