...
v9.23 adds the smallest transport primitive after bidirectional Node/Go task interop: an explicit Go federation bind host and honest local/public posture reporting. The next natural boundary should avoid further sandbox probe polish and move toward real container namespace execution proof, public deployment/QUIC, cross-implementation conformance fixtures, or another small Ultimate-aligned runtime/governance slice.
