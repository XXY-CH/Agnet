...
Go
  ...
  -> filesystem artifact mirrors maintain and verify an objects.ndjson content-addressed object index with exact manifest field matching
  ...
  -> audit verifier checks optional filesystem artifact mirror bytes, sidecars, and exact-type object index entries when --artifact-store is configured
