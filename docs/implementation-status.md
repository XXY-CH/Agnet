...
状态：v13 active at v13.0
当前代码基线：`v13.0-opening-alignment`
...
v13 is open but has not yet added hosted reachability, semantic ranking, dynamic scheduling, remote attestation, or SBOM runtime capability.
