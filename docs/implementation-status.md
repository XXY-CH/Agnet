...
v8.5 adds a read-only security posture API for the localhost-bound Human Gateway. The next natural boundary is browser key management UI or the next deployable transport/security hardening slice.
