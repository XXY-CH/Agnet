...
v8.31 rejects direct approval body actors that mismatch the configured bearer approval session actor. The next natural boundary is login-state UI, container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
