...
状态：v9.13 complete
当前代码基线：`v9.13-sandbox-claim-preapproval-gate`
...
v9.13 rejects unsupported sandbox claims before Human Gateway approval state/events. The next natural boundary is real container namespace sandboxing or another small Ultimate-aligned runtime/governance slice.
