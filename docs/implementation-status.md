...
v9.25 adds the matching shared cross-implementation `FED_RECEIPT` conformance fixture after the `FED_TASK_OPEN` fixture. The next natural boundary should avoid further sandbox probe polish and move toward real container namespace execution proof, public deployment/QUIC, more cross-implementation conformance fixtures, or another small Ultimate-aligned runtime/governance slice.
