...
状态：v13 active at v13.9
当前代码基线：`v13.9-hosted-observer-runner`
...
The active protocol tag is `v13.9-protocol`: hosted observer runner support is the latest complete slice, while the v13.1 hosted external-host observer run and hardware remote attestation remain pending exit criteria.
...
| Capability query | done + Node federation gateway evidence-first semantic discovery/reputation ranking | done | `federation-gateway.test.mjs`, `go-fed-discovery.test.mjs` | Go query parity / scheduling |
