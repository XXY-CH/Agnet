...
v8.42 exposes audit hash-chain entry headers on receipt-scoped artifact reads. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
