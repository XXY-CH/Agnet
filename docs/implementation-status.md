...
v9.12 exposes sandbox runtime support through `--sandbox-probe <claim>`, including explicit unsupported `container-namespace` evidence. The next natural boundary is real container namespace sandboxing or another small Ultimate-aligned runtime/governance slice.
