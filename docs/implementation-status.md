...
v8.43 makes task-scoped audit receipt proofs self-contained by returning the selected receipt audit hash. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
