...
v8.39 exposes signed digest headers on receipt-scoped artifact reads. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
