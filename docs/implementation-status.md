...
v10.6 is closed. The next natural boundary should keep making the accountability layer easier to verify externally: package receipt verification, publish a narrow ASP Core draft, or provide a reproducible public-node/Docker demo.
