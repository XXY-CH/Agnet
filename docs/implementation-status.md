...
状态：v8.24 complete
当前代码基线：`v8.24-transcript-artifact-storage`
...
v8.24 persists external/MCP result transcripts as local artifacts linked from signed receipts. The next natural boundary is remote artifact storage, container sandbox hardening, login-backed approval identity, streamed transcript UI, or another small Ultimate-aligned runtime/governance slice.
