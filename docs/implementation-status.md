...
v10.7 is closed. The next natural boundary should keep making the accountability layer easier to verify externally: package receipt verification or provide a reproducible public-node/Docker demo.
