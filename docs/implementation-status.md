...
状态：v12.19 active
当前代码基线：`v12.19-package-artifact-sha256`
...
Node
  ...
  -> scripts/package-proof.mjs creates a local npm tarball artifact with npm shasum, integrity, SHA-256, size, and file-list metadata
