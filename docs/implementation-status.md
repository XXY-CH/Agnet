...
v8.33 displays read-only local approval session state in the Human Gateway page. The next natural boundary is container namespace sandboxing, streamed transcript UI, object-store-backed artifacts, or another small Ultimate-aligned runtime/governance slice.
