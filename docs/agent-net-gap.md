...
- `scripts/public-node-proof.sh` starts the Go federation gateway on `0.0.0.0`, proves `public_transport: true` locally, and completes one authenticated `FED_RESOLVE` TCP round trip。
