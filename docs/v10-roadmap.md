...
## v10.36: Public Swarm Close Trusted Zone File
...
## v10.45: Verified Artifact SHA-256 Output
...
- `asp-verify.mjs fed-receipt-artifacts` prints `artifact_sha256s` on success.
- `scripts/proof-demo.sh` forwards `artifact_sha256s` from the verifier CLI.
- `scripts/public-node-proof.mjs` forwards `artifact_sha256s` from the verifier CLI.
- Vector, proof demo, and public proof tests pin the verified SHA-256 list.
...
## v10.46: Verified Artifact Manifest Hash Output
...
- `asp-verify.mjs fed-receipt-artifacts` prints `artifact_manifest_hashes` on success.
- `scripts/proof-demo.sh` forwards `artifact_manifest_hashes` from the verifier CLI.
- `scripts/public-node-proof.mjs` forwards `artifact_manifest_hashes` from the verifier CLI.
- Vector, proof demo, and public proof tests pin the verified manifest-hash list.
