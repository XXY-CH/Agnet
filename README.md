...
- Latest boundary: [docs/v8.15-boundary.md](docs/v8.15-boundary.md)
...
- Human Gateway queue actions require signed action grants with actor binding, local actor policy, action scope, expiry, and durable nonce-backed replay rejection.
