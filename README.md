...
Status: research prototype, local-first, v10 active at `v10.5-protocol`.
...
- Receipt verification through Go and Node CLIs.
...
- `docs/v10.5-boundary.md` - latest closed boundary.
- `docs/v9-roadmap.md` - closed v9 roadmap.

## Roadmap

v9 is closed. v10 is making the proof layer easier to verify externally: identity bridge first, then Node artifact manifest parity, receipt-side manifest metadata checks, local artifact byte checks, and minimal verifier CLIs.
