...
Status: research prototype, local-first, v11 active at `v11.66-protocol`.
...
- Protocol-native checkpoint evidence, with malformed receipt checkpoint evidence list rejection.
...
- `docs/v11.66-boundary.md` - latest closed boundary.
