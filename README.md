...
Status: research prototype, local-first, v11 active at `v11.43-protocol`.
...
- Node artifact manifests, AFP strings, sidecars, local URI validation, local byte verification, CLI verification, object presence validation, and manifest metadata verification; Go filesystem artifact manifests, AFP strings, content-addressed mirrors, and GC plan/apply.
...
- `docs/v11.43-boundary.md` - latest closed boundary.
