...
- Latest boundary: [docs/v9.29-boundary.md](docs/v9.29-boundary.md)
...
- Go audit verification rejects signed Swarm dependency claims that do not match declared dependency steps, upstream step artifact manifests, or receipt digests.
