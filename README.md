...
Status: research prototype, local-first, v12 active at `v12.43-protocol`.
...
- `docs/v12.43-boundary.md` - latest closed boundary.
...
2. Add release transparency or SBOM against the produced package artifact only when that signature/SBOM format is explicitly scoped.
