...
- Latest boundary: [docs/v9.30-boundary.md](docs/v9.30-boundary.md)
...
- Go audit verification rejects signed Swarm dependency claims that do not match declared dependency steps, upstream step artifact manifests, receipt digests, or unique step identity.
