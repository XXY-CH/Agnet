...
Status: research prototype, local-first, v11 active at `v11.73-protocol`.
...
- Human approval evidence for direct and queued execution, with malformed receipt approval evidence list rejection and worker policy approval-required list rejection.
...
- `docs/v11.73-boundary.md` - latest closed boundary.
