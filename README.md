...
- Latest boundary: [docs/v7.12-boundary.md](docs/v7.12-boundary.md)
...
- Human Gateway queue actions require signed action grants with actor binding, action scope, expiry, and replay rejection.
