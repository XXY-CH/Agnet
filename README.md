...
- Latest boundary: [docs/v8.17-boundary.md](docs/v8.17-boundary.md)
...
- Go records external/MCP tool command and executable binary digests in sandbox evidence.
