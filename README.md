...
Status: research prototype, local-first, v12 active at `v12.38-protocol`.
...
- `docs/v12.38-boundary.md` - latest closed boundary.
...
2. Add external signer trust pin or SBOM against the produced package artifact only when that signature/SBOM format is explicitly scoped.
