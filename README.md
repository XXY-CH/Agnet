...
Status: research prototype, local-first, v10 active at `v10.40-protocol`.
...
- Node receipt verifier CLI outputs include stable `receipt_digest` values for external reports.
...
- `docs/v10.40-boundary.md` - latest closed boundary.
