...
Status: research prototype, local-first, v12 active at `v12.19-protocol`.
...
- Minimal npm-facing package contract for the existing Node verifier CLI and `asp-core.mjs` exports, plus an npm tarball proof that emits package filename, size, SHA-1 shasum, SHA-512 integrity, ASP-style SHA-256, and packaged file list.
...
- `docs/v12.19-boundary.md` - latest closed boundary.
