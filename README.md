...
Status: research prototype, local-first, v11 active at `v11.24-protocol`.
...
- `FED_TASK_OPEN` verifies frame object/type, origin Zone descriptor and payload object presence, and requester Zone bindings at the federation boundary.
...
- Node task, receipt, and Swarm close verifiers reject missing trusted Zone stores before reading trust entries.
...
- `docs/v11.24-boundary.md` - latest closed boundary.
