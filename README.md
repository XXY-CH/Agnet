...
Status: research prototype, local-first, v11 active at `v11.29-protocol`.
...
- Ed25519 `aid:` agent identity and Zone identity with descriptor public key presence validation before crypto parsing.
...
- `docs/v11.29-boundary.md` - latest closed boundary.
