...
Status: research prototype, local-first, v11 active at `v11.30-protocol`.
...
- Ed25519 `aid:` agent identity and Zone identity with descriptor public key presence validation and object signature type validation before crypto parsing.
...
- `docs/v11.30-boundary.md` - latest closed boundary.
