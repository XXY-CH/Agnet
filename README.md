...
Status: research prototype, local-first, v13 active at `v13.11-protocol`.
...
The protocol tag advanced with v13.11 because it is the latest complete slice; upper-layer demo/master-agent orchestration plus A2A/ARD compatibility stay outside the current core.
