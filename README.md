...
- Latest boundary: [docs/v9.27-boundary.md](docs/v9.27-boundary.md)
...
- Go audit verification rejects signed Swarm dependency claims that do not match upstream step artifact manifests.
