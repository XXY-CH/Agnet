...
Status: research prototype, local-first, v10 active at `v10.15-protocol`.
...
- Swarm audit verification for declared dependency steps, unique step identity, artifact manifests, upstream receipt digests, and ordered complete audit-backed Zone-signed close proofs.
