...
- Latest boundary: [docs/v7.11-boundary.md](docs/v7.11-boundary.md)
...
- Human Gateway queue actions require signed action grants with action scope, expiry, and replay rejection.
