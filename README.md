...
Status: research prototype, local-first, v10 active at `v10.43-protocol`.
...
- One-command proof demo, Docker proof demo, and Docker public-listen proof that emit verifier-ready receipt/trust files, expose receipt digests and verified artifact counts, verify local artifact closure, and support base-image override env vars for restricted Docker environments.
