...
Status: research prototype, local-first, v11 active at `v11.74-protocol`.
...
- Human approval evidence for direct and queued execution, with malformed receipt approval evidence list rejection, receipt policy scope list rejection, and worker policy approval-required list rejection.
...
- `docs/v11.74-boundary.md` - latest closed boundary.
