...
Status: research prototype, local-first, v11 active at `v11.14-protocol`.
...
- Shared `FED_TASK_OPEN`, `FED_RECEIPT`, and `FED_SWARM_CLOSE` conformance fixtures, including fail-closed checks for missing-identity, NUL-bearing, empty, and duplicate-step Swarm close proofs.
...
- `docs/v11.14-boundary.md` - latest closed boundary.
