...
Status: research prototype, local-first, v10 active at `v10.12-protocol`.
...
- Swarm audit verification for declared dependency steps, unique step identity, artifact manifests, upstream receipt digests, and Zone-signed close proof digests.
