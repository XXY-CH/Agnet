...
Status: research prototype, local-first, v13 active at `v13.9-protocol`.
...
The protocol tag advanced with v13.9 because it is the latest complete slice; upper-layer demo/master-agent orchestration plus A2A/ARD compatibility stay outside the current core.
